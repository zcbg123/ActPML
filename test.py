...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_id', type=str, default='0', help='train use gpu')  #change
    parser.add_argument('--data_name', type=str, default='LEVIR', #change
                        help='the test rgb images root')
    parser.add_argument('--model_name', type=str, default='ActPML', #change
                        help='the test rgb images root')
    ...
    opt.load = './outputAL/' + opt.data_name + '/' + opt.model_name + '_best_iou.pth'
